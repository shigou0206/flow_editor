...
//               .updateInsertingNodePreview(localPos, highlightedEdgeId);
//         } else if (details.data.isGroup) {
//           debugPrint("🔥 Updating inserting group preview: $highlightedEdgeId");
//           ctrl.interaction
//               .updateInsertingGroupPreview(localPos, highlightedEdgeId);
//         }
//       },
...
//         debugPrint('data type: ${details.data.runtimeType}');
//         debugPrint('data isNode: ${details.data.isNode}');
//         debugPrint('data isGroup: ${details.data.isGroup}');

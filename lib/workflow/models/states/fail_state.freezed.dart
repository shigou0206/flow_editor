...
// 明确声明为null
  ...
  @override
  String toString() {
    return 'FailState(type: $type, comment: $comment, error: $error, cause: $cause, next: $next, end: $end, retry: $retry, catchPolicy: $catchPolicy)';
  }
...
abstract class _FailState extends FailState {
  const factory _FailState(
      ...
      final List<CatchPolicy>? catchPolicy}) = _$FailStateImpl;

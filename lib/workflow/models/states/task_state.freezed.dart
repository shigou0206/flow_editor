...
class _$TaskStateImpl implements _TaskState {
  ...
  @override
  String toString() {
    return 'TaskState(type: $type, comment: $comment, next: $next, end: $end, resource: $resource, parameters: $parameters, executionConfig: $executionConfig, heartbeatSeconds: $heartbeatSeconds, heartbeatExpr: $heartbeatExpr, retry: $retry, catchPolicy: $catchPolicy)';
  }
...
abstract class _TaskState implements TaskState {
  const factory _TaskState(
      ...
      final String? heartbeatExpr,
      final List<RetryPolicy>? retry,
      final List<CatchPolicy>? catchPolicy}) = _$TaskStateImpl;

...
mixin _$ChoiceState {
  ...
  bool? get end => throw _privateConstructorUsedError; // 明确声明为null
...
// 明确声明为null
  ...
  @override
  String toString() {
    return 'ChoiceState(type: $type, comment: $comment, choices: $choices, defaultNext: $defaultNext, next: $next, end: $end, retry: $retry, catchPolicy: $catchPolicy)';
  }
...
abstract class _ChoiceState extends ChoiceState {
  const factory _ChoiceState(
      ...
      final List<CatchPolicy>? catchPolicy}) = _$ChoiceStateImpl;

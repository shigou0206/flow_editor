...
class ChangeNodeStatusCommand implements ICommand {
  ...
  String get description =>
      'Change node $nodeId status to $newStatus' +
      (newData != null ? ' and update data' : '');

  @override
  Future<void> execute() async {
    final st = ctx.getState() as EditorState;
    ...
    _oldStatus = oldNode.status ?? NodeStatus.pending;
    _oldData = oldNode.data == null ? null : Map.of(oldNode.data!);

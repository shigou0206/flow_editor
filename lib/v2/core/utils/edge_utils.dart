import 'package:flow_editor/v2/core/models/edge/edge_model.dart';
import 'package:flow_editor/v2/core/models/node/node_model.dart';
...
List<Offset> mapEdgeWaypointsToAbsolute(
  ...
  if (source.parentId == null) {
    return edge.waypoints.map((pt) => pt.toOffset()).toList();
  }
  ...
  return edge.waypoints
      .map((pt) => Offset(pt.x + groupAbs.dx, pt.y + groupAbs.dy))
      .toList();
}

...
class _LayoutDemoPageState extends ConsumerState<LayoutDemoPage> {
  ...
  List<EdgeModel> _initEdges() => [
        EdgeModel.generated(sourceNodeId: 'root1', targetNodeId: 'node11'),
        EdgeModel.generated(sourceNodeId: 'node11', targetNodeId: 'node12'),
        EdgeModel.generated(sourceNodeId: 'node11', targetNodeId: 'group2'),
        EdgeModel.generated(sourceNodeId: 'node21', targetNodeId: 'node22'),
        EdgeModel.generated(sourceNodeId: 'node21', targetNodeId: 'node23'),
        EdgeModel.generated(sourceNodeId: 'node24', targetNodeId: 'node23'),
        EdgeModel.generated(sourceNodeId: 'group2', targetNodeId: 'nodeend'),
        EdgeModel.generated(sourceNodeId: 'node12', targetNodeId: 'nodeend'),
        EdgeModel.generated(sourceNodeId: 'node11', targetNodeId: 'nodeend'),
      ];
